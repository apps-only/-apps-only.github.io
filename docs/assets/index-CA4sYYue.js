...
`,fn="s-badge",pn={};class un extends I({name:fn,props:pn,style:dn,setup(){return{render:()=>A`
        <slot></slot>
      `}}}){}un.define();const bo=matchMedia("(pointer:coarse)");bo.addEventListener("change",({matches:e})=>me.touched=e);const me={touched:bo.matches,addEventListener:e=>bo.addEventListener("change",()=>e(me.touched))},qt=document.createElement("div");qt.setAttribute("style","position: fixed;right: 0;bottom: 0;width: 100%;height: 100%;pointer-events: none");const Ut=e=>{e.appendChild(qt);const t=qt.getBoundingClientRect();return e.removeChild(qt),{left:t.left,top:t.top,width:t.width,height:t.height}},hn=`
:host{
...
`,An="s-checkbox",In={disabled:!1,checked:!1,indeterminate:!1},Ye={indeterminate:"M280-440h400v-80H280v80Zm-80 320q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Z",uncheck:"M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Z",checked:"m424-312 282-282-56-56-226 226-114-114-56 56 170 170ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Z"};class qn extends I({name:An,style:Mn,props:In,propSyncs:!0,setup(){let t;return this.addEventListener("click",()=>{if(this.indeterminate)return this.indeterminate=!1;this.checked=!this.checked,this.dispatchEvent(new Event("change"))}),{watches:{indeterminate:o=>t.setAttribute("d",o?Ye.indeterminate:this.checked?Ye.checked:Ye.uncheck),checked:o=>!this.indeterminate&&t.setAttribute("d",o?Ye.checked:Ye.uncheck)},render:()=>A`
        <svg class="icon color" viewBox="0 -960 960 960">
          <path ref="${o=>t=o}" d="${Ye.uncheck}"></path>
        </svg>
...
`,Pn="s-chip",On={type:"outlined",clickable:!1};class Hn extends I({name:Pn,style:zn,props:On,propSyncs:!0,setup(){return{render:()=>A`
        <slot name="start"></slot>
        <slot></slot>
        <slot name="end"></slot>
        <slot name="action" @pointerdown.stop></slot>
...
`,Il="s-tbody",ql={};class zl extends I({name:Il,style:Al,props:ql,setup(){return{render:()=>A`
        <slot></slot>
      `}}}){}const Pl=`
:host{
  display: table-row;
...
`,Wl="s-td",Zl={colspan:1,rowspan:1};class Ul extends I({name:Wl,style:Dl,props:Zl,setup(){let t;return{watches:{colspan:o=>t.colSpan=o,rowspan:o=>t.rowSpan=o},render:()=>A`
      ...
      `}}}){}El.define();Ml.define();zl.define();Nl.define();Bl.define();Ul.define();const Vl=`
:host{
  display: inline-block;
  vertical-align: middle;
  min-width: 280px;
