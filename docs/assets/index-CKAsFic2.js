...
`,Vi="s-segmented-button",Ki={};class vo extends M({name:Vi,style:Ui,props:Ki,setup(){let t=[],o=-1,s=!1;const r=(i,l)=>{t=l.assignedElements().filter(f=>f instanceof Gs),o=-1;let a=null;for(const f of t)f.selected&&(a=f);a&&n(a)},n=i=>{if(t.length===0||!i.selected)return o=-1;for(const l of t)l!==i&&l.selected&&l.removeAttribute("selected");o=t.indexOf(i),s&&(this.dispatchEvent(new Event("change")),s=!1)};return this.addEventListener("segmented-button-item:update",i=>{i.stopPropagation(),n(i.target)}),this.addEventListener("segmented-button-item:change",i=>{i.stopPropagation(),s=!0}),{expose:{get options(){return t},get selectedIndex(){return o}},render:()=>I`
        <slot @slotchange="${r}"></slot>
      `}}}){}const Gi=`
:host{
  flex-basis: 100%;
...
`,Xi="s-segmented-button-item",Yi={selected:!1,disabled:!1,selectable:!0};class Gs extends M({name:Xi,style:Gi,props:Yi,propSyncs:["selected","disabled"],setup(){return this.addEventListener("click",()=>{if(this.selectable){if(this.selected)return;this.parentNode instanceof vo&&this.dispatchEvent(new Event("navigation-item:change",{bubbles:!0})),this.selected=!0}}),{watches:{selected:()=>{this.parentNode instanceof vo&&this.dispatchEvent(new Event("segmented-button-item:update",{bubbles:!0}))}},render:()=>I`
        <slot name="start"></slot>
        <slot></slot>
        <slot name="end"></slot>
        <s-ripple class="ripple" attached="true"></s-ripple>
      `}}}){}vo.define();Gs.define();const Ji=`
:host{
  display: block;
  color: var(--s-color-primary, #5256a9);
  height: 40px;
...
`,hl="s-tab-item",ml={selected:!1};class Xs extends M({name:hl,style:ul,props:ml,propSyncs:!0,setup(){let t,o;const s=(r,n)=>{const i=n.assignedElements().length;t.classList[i>0?"add":"remove"]("icon")};return this.addEventListener("click",()=>{this.selected||(this.parentNode instanceof bo&&this.dispatchEvent(new Event("tab-item:change",{bubbles:!0})),this.selected=!0)}),{expose:{get indicator(){return o}},watches:{selected:()=>{this.parentNode instanceof bo&&this.dispatchEvent(new Event("tab-item:update",{bubbles:!0}))}},render:()=>I`
...
`,Gl="s-top-app-bar",Xl={};class Yl extends M({name:Gl,style:Kl,props:Xl,setup(){return{render:()=>I`
...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Oo(e,t){const o=new Set(e.split(","));return s=>o.has(s)}const Z={},Ye=[],fe=()=>{},Jl=()=>!1,Ft=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),No=e=>e.startsWith("onUpdate:"),Q=Object.assign,zo=(e,t)=>{const o=e.indexOf(t);o>-1&&e.splice(o,1)},Ql=Object.prototype.hasOwnProperty,N=(e,t)=>Ql.call(e,t),S=Array.isArray,Je=e=>Bt(e)==="[object Map]",Ys=e=>Bt(e)==="[object Set]",q=e=>typeof e=="function",G=e=>typeof e=="string",ze=e=>typeof e=="symbol",K=e=>e!==null&&typeof e=="object",Js=e=>(K(e)||q(e))&&q(e.then)&&q(e.catch),Qs=Object.prototype.toString,Bt=e=>Qs.call(e),ea=e=>Bt(e).slice(8,-1),er=e=>Bt(e)==="[object Object]",Ro=e=>G(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,at=Oo(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Dt=e=>{const t=Object.create(null);return o=>t[o]||(t[o]=e(o))},ta=/-(\w)/g,et=Dt(e=>e.replace(ta,(t,o)=>o?o.toUpperCase():"")),oa=/\B([A-Z])/g,ot=Dt(e=>e.replace(oa,"-$1").toLowerCase()),tr=Dt(e=>e.charAt(0).toUpperCase()+e.slice(1)),ro=Dt(e=>e?`on${tr(e)}`:""),Ve=(e,t)=>!Object.is(e,t),no=(e,...t)=>{for(let o=0;o<e.length;o++)e[o](...t)},or=(e,t,o,s=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:s,value:o})},sa=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let fs;const sr=()=>fs||(fs=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Wt(e){if(S(e)){const t={};for(let o=0;o<e.length;o++){const s=e[o],r=G(s)?la(s):Wt(s);if(r)for(const n in r)t[n]=r[n]}return t}else if(G(e)||K(e))return e}const ra=/;(?![^(]*\))/g,na=/:([^]+)/,ia=/\/\*[^]*?\*\//g;function la(e){const t={};return e.replace(ia,"").split(ra).forEach(o=>{if(o){const s=o.split(na);s.length>1&&(t[s[0].trim()]=s[1].trim())}}),t}function Ho(e){let t="";if(G(e))t=e;else if(S(e))for(let o=0;o<e.length;o++){const s=Ho(e[o]);s&&(t+=s+" ")}else if(K(e))for(const o in e)e[o]&&(t+=o+" ");return t.trim()}const aa="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",ca=Oo(aa);function rr(e){return!!e||e===""}const At=e=>G(e)?e:e==null?"":S(e)||K(e)&&(e.toString===Qs||!q(e.toString))?JSON.stringify(e,nr,2):String(e),nr=(e,t)=>t&&t.__v_isRef?nr(e,t.value):Je(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((o,[s,r],n)=>(o[io(s,n)+" =>"]=r,o),{})}:Ys(t)?{[`Set(${t.size})`]:[...t.values()].map(o=>io(o))}:ze(t)?io(t):K(t)&&!S(t)&&!er(t)?String(t):t,io=(e,t="")=>{var o;return ze(e)?`Symbol(${(o=e.description)!=null?o:t})`:e};/**
