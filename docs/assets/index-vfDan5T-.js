...
`,Nn="s-scroll-view",zn={};class Hn extends M({name:Nn,style:On,props:zn,setup(){return{render:()=>I`
        <slot></slot>
      `}}}){}Hn.define();const Rn=`
:host{
  display: inline-block;
...
`,Ri="s-rate",ji={readonly:!1,max:10,min:0,value:5,step:1};class Fi extends M({name:Ri,style:Hi,props:ji,propSyncs:["readonly"],setup(){let t,o;const s=()=>{const n=(Number(o.value)-this.min)*100/this.max-this.min;t.style.width=`${n}%`};return{watches:{max:r=>{const n=String(r);o.max!==n&&(o.max=n,s())},min:r=>{const n=String(r);o.min!==n&&(o.min=n,s())},step:r=>{const n=String(r);o.step!==n&&(o.step=n,s())},value:r=>{const n=String(r);o.value!==n&&(o.value=n,s())}},render:()=>I`
        <div class="unchecked">
          <slot name="unchecked">
            <svg viewBox="0 -960 960 960">
...
`,zl="s-td",Hl={colspan:1,rowspan:1};class Rl extends M({name:zl,style:Nl,props:Hl,setup(){let t;return{watches:{colspan:o=>t.colSpan=o,rowspan:o=>t.rowSpan=o},render:()=>I`
        <td ref="${o=>t=o}" rowspan="${this.rowspan}" colspan="${this.colspan}">
          <slot></slot>
        </td>
      `}}}){}bl.define();kl.define();Tl.define();Il.define();Ol.define();Rl.define();const jl=`
:host{
  display: inline-block;
  vertical-align: middle;
  min-width: 280px;
